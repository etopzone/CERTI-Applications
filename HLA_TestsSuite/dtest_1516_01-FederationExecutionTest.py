...
firstFederate.addRunStep("barrier","1516-01-FederationExecution Sequence starts...")
...
firstFederate.addRunStep("sendToCommand",string="\n")
firstFederate.addRunStep("expectFromCommand",pattern="09E Pass: Created federation.*")
...
firstFederate.addRunStep("expectFromCommand",pattern="18E Pass: Destroyed federation.*")
firstFederate.addRunStep("ok",firstFederate.getFutureLastStepStatus,"Destroyed federation")
