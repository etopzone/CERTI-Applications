...
const char *gengetopt_args_info_purpose = "test HLA interaction and object class inheritance";

const char *gengetopt_args_info_usage = "Usage: test_Inheritance [-v] -f <fedfile> -n <FederationName> -j <joinName> [-p] [-o \n<ObjectClassName> [-a <AttributeName>]] [-i <InteractionClassName> [-p \n<ParameterName]]";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -s, --subscribe           subscribe mode, if present the federate will be a \n                              subscriber (otherwise publisher)  (default=off)",
  "  -o, --objectclass=STRING  The object class for which you want to know the \n                              handle",
  "  -a, --attribute=STRING    The attribute name (needs -o) for which you want to \n                              know the handle",
  "  -i, --interaction=STRING  The interaction class for which you want to know \n                              the handle",
  "  -p, --parameter=STRING    The parameter name (needs -i) for which you want to \n                              know the handle",
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVf:n:j:so:a:i:p:vt:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'j':	/* The federate name used to join the federation.  */
          ...
          break;
        case 's':	/* subscribe mode, if present the federate will be a subscriber (otherwise publisher).  */
        
        
          if (update_arg((void *)&(args_info->subscribe_flag), 0, &(args_info->subscribe_given),
          ...
          break;
        case 'o':	/* The object class for which you want to know the handle.  */
          ...
          break;
        case 'a':	/* The attribute name (needs -o) for which you want to know the handle.  */
          ...
          break;
        case 'i':	/* The interaction class for which you want to know the handle.  */
          ...
          break;
        case 'p':	/* The parameter name (needs -i) for which you want to know the handle.  */
