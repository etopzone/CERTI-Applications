...
otherFederate.addRunStep("ok",firstFederate.getFutureLastStepStatus,"Second Federate started and has joined federation")
...
otherFederate.addRunStep("ok",firstFederate.getFutureLastStepStatus,firstFederate.name+" has quit federation")
