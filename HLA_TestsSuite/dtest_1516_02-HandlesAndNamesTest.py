...
firstFederate.addRunStep("barrier","1516-01-02-HandlesAndNamesTest Sequence starts...")
firstFederate.addRunStep("expectFromCommand",pattern="01E Pass: Federation joined. Press enter to continue with test.")

firstFederate.addRunStep("sendToCommand",string="\n")
firstFederate.addRunStep("expectFromCommand",pattern="28E Pass: Got expected object name")
firstFederate.addRunStep("ok",firstFederate.getFutureLastStepStatus,"All tests passed.")

firstFederate.addRunStep("expectFromCommand",pattern="Test operations performed. Press enter to continue with shutdown.")
firstFederate.addRunStep("sendToCommand",string="\n")
firstFederate.addRunStep("expectFromCommand",pattern="Press enter to stop connection to RTI.")
firstFederate.addRunStep("ok",firstFederate.getFutureLastStepStatus,"Stopping RTI")
...
def goTest():
    myDTestMaster = dtest.DTestMaster("HLA test 1516-01-FederationExecution","Launch RTIG + 1516-Create/Destroy/Join/Resign FederationExecution,...")
