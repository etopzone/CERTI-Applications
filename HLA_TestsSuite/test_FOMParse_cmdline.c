...
const char *gengetopt_args_info_usage = "Usage: test_FOMParse [-v] -f <fedfile> -n <FederationName> [-o <ObjectClassName> [-a <AttributeName>]] [-i <InteractionClassName> [-p <ParameterName]]";
