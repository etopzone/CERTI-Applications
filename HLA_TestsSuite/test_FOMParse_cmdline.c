...
const char *gengetopt_args_info_help[] = {
  ...
  "  -a, --attribute=STRING    The attribute name to subscribe to (or publish)",
  "  -i, --interaction=STRING  The interaction class name to subscribe to (or \n                              publish)",
  "  -p, --parameter=STRING    The parameter name to subscribe to (or publish)",
...
cmdline_parser_file_save(const char *filename, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->objectclass_given) {
    if (args_info->objectclass_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "objectclass", args_info->objectclass_orig);
    } else {
      fprintf(outfile, "%s\n", "objectclass");
    }
  }
  ...
  if (args_info->interaction_given) {
    if (args_info->interaction_orig) {
      fprintf(outfile, "%s=\"%s\"\n", "interaction", args_info->interaction_orig);
    } else {
      fprintf(outfile, "%s\n", "interaction");
    }
  }
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVf:n:j:o:a:i:p:v", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'f':	/* The FED file (XML or FED) to be used.  */
          if (local_args_info.fedfile_given || (check_ambiguity && args_info->fedfile_given))
            {
              fprintf (stderr, "%s: `--fedfile' (`-f') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
        ...
        case 'n':	/* The Federation name.  */
          if (local_args_info.fedname_given || (check_ambiguity && args_info->fedname_given))
            {
              fprintf (stderr, "%s: `--fedname' (`-n') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
        ...
        case 'j':	/* The federate name used to join the federation.  */
          if (local_args_info.joinname_given || (check_ambiguity && args_info->joinname_given))
            {
              fprintf (stderr, "%s: `--joinname' (`-j') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
        ...
        case 'o':	/* The object class to subscribe to (or publish).  */
          if (local_args_info.objectclass_given || (check_ambiguity && args_info->objectclass_given))
            {
              fprintf (stderr, "%s: `--objectclass' (`-o') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
        ...
        case 'a':	/* The attribute name to subscribe to (or publish).  */
          if (local_args_info.attribute_given || (check_ambiguity && args_info->attribute_given))
            {
              fprintf (stderr, "%s: `--attribute' (`-a') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
        ...
        case 'i':	/* The interaction class name to subscribe to (or publish).  */
          if (local_args_info.interaction_given || (check_ambiguity && args_info->interaction_given))
            {
              fprintf (stderr, "%s: `--interaction' (`-i') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
        ...
        case 'p':	/* The parameter name to subscribe to (or publish).  */
          if (local_args_info.parameter_given || (check_ambiguity && args_info->parameter_given))
            {
              fprintf (stderr, "%s: `--parameter' (`-p') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
