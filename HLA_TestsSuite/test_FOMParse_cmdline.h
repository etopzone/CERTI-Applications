...
struct gengetopt_args_info
{
  ...
  char * objectclass_arg;	/**< @brief The object class to subscribe to (or publish).  */
  char * objectclass_orig;	/**< @brief The object class to subscribe to (or publish) original value given at command line.  */
  const char *objectclass_help; /**< @brief The object class to subscribe to (or publish) help description.  */
  char * attribute_arg;	/**< @brief The attribute name to subscribe to (or publish).  */
  char * attribute_orig;	/**< @brief The attribute name to subscribe to (or publish) original value given at command line.  */
  const char *attribute_help; /**< @brief The attribute name to subscribe to (or publish) help description.  */
  char * interaction_arg;	/**< @brief The interaction class name to subscribe to (or publish).  */
  char * interaction_orig;	/**< @brief The interaction class name to subscribe to (or publish) original value given at command line.  */
  const char *interaction_help; /**< @brief The interaction class name to subscribe to (or publish) help description.  */
  char * parameter_arg;	/**< @brief The parameter name to subscribe to (or publish).  */
  char * parameter_orig;	/**< @brief The parameter name to subscribe to (or publish) original value given at command line.  */
  const char *parameter_help; /**< @brief The parameter name to subscribe to (or publish) help description.  */
