...
%syncPointRegSucceeded    Synchronization Point Registration Succeeded (rti initiated).
%
%Synopsis
%	except = synPointRegSucceeded(label)
%
%Purpose:
%   To inform a federate that an attempt to register a synchronization point has
%   succeeded.
